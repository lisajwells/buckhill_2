...
<a href="<?php echo esc_url( tribe_get_event_link() ); ?>" rel="bookmark"><div class="tribe-mini-calendar-event event-<?php esc_attr_e( $mini_cal_event_atts['current_post'] ); ?> <?php esc_attr_e( $mini_cal_event_atts['class'] ); ?>">
 ...
 </div></a> <!-- tribe-mini-calendar-event -->
